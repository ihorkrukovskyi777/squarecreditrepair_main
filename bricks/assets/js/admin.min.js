...
function bricksDeleteTemplateScreenshots() {
	...
	button.addEventListener('click', function (e) {
		...
		var confirmed = confirm(bricksData.confirmDeleteTemplateScreenshots)
...
function bricksRunIndexJob() {
	...
	if (!button || !progressText || !checkIcon) {
		return
	}
	...
	button.addEventListener('click', function (e) {
		...
		if (!noConfirm) {
			var confirmed = confirm(bricksData.confirmTriggerIndexJob)
...
function bricksRegenerateCodeSignatures() {
	...
	button.addEventListener('click', function (e) {
		...
		var confirmed = confirm(bricksData.confirmRegenerateCodeSignatures)
